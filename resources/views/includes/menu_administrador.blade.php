...
<li class="{{request()->is('users*')? 'active':''}}">
    <a title="Usuarios" href="{{route('users.index')}}" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Usuarios</span></a>
</li>
