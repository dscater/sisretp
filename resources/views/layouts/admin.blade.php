    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="{{ route('home') }}"><img class="main-logo" src="@yield('logo')" alt=""
                        style="height:125px!important;" /></a>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <div role="menu"
                                                                ...
                                                                <div class="message-view">
                                                                    <a href="{{ route('mensajes.index') }}">Ver todos
                                                                        los mensajes</a>
                                                                </div>
                                                            </div>
                                                        </li>
                                                ...
                                                <li class="nav-item nav-setting-open">
                                                    ...
                                                    <ul role="menu"
                                                        ...
                                                        id="menu_user">
                                                        <li><a href="{{ route('users.config', Auth::user()->id) }}"><span
                                                        ...
                                                        document.getElementById('logout-form').submit();">
                                                                <span
                                                                    class="edu-icon edu-locked author-log-ic"></span>Salir
                                                            </a>
                                                        </li>
