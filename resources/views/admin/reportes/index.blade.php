...
<div class="product-status mg-b-15">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="{{route('reportes.usuarios')}}" target="_blank" class="btn btn-primary reporte">
                    <span>
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="{{route('reportes.lista_titulados')}}" target="_blank" class="btn btn-primary reporte">
                    <span>
                        <i class="fa fa-graduation-cap"></i>
                    </span>
                    <span>
