                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Nueva carrera</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        <div id="dropzone1" class="pro-ad">
                                            {!! Form::open(['route'=>'carreras.store','method'=>'post','files'=>'true','id'=>'demo1-upload', 'class'=>'dropzone dropzone-custom needsclick add-professors']) !!}
