...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-05-2019 a las 17:32:05
...
(1, 'EMP-01', '1111556878', '56565555', '111155500', 'REGISTRO DE PROFESIONALES LEGALES EN BOLIVIA', 'E.P.', 'BOLIVIA', 'LA PAZ', 'LA PAZ', 'LAS LOMAS', 'LOS HEROES', '551', NULL, '224578', '68412345', NULL, NULL, NULL, 'logo.jpg', 'SIN FINES DE LUCRO', '2019-04-29 18:29:14', '2019-04-29 18:29:14');
...
(4, 'FELIPE1556838349.pdf', '1561', '15656', 'UNIVERSIDAD MAYOR DE SAN ANDRES', 'LICENCIATURA', 'INFORMATICO', '2012-01-01', 4, 1, '2019-05-02 23:05:50', '2019-05-02 23:05:50'),
...
(4, 'VICTOR', 'victorgonzalo.as@gmail.com', '$2y$10$q0r2Hc/mjoaI9wEpslAp4O2o1At7PhxrPCef462Mr0JfQYRFxEMjm', 'VICTOR1557242907.jpg', 'TITULADO', 1, '2019-04-29 18:43:10', '2019-05-07 15:28:27'),
(5, 'GONZALO', 'victorgonzalo_as@hotmail.com', '$2y$10$xtoJs89cGiwtOoL/mRLNheK7oPWkpOBlpEUHNoiYsE741rRzi4tke', 'user_default.png', 'EMPLEADOR', 1, '2019-04-29 19:08:24', '2019-05-01 22:56:46'),
...
(7, 'JORGE', 'jorge@hotmail.com', '$2y$10$EhRZ.qF/Et14HzMPyW0tf.dQrm2uzD8G4Zv4Kfu53/sJ7JO7NpPN6', 'user_default.png', 'TITULADO', 1, '2019-05-01 22:02:37', '2019-05-02 22:51:22'),
...
(12, 'LUIS', 'luis@gmail.com', '$2y$10$HDupSyfI3yR4gOtY7xR4BO39A1A5b1eWuhMT6eO1HXDJm21.b5C2u', 'user_default.png', 'TITULADO', 1, '2019-05-02 23:38:19', '2019-05-02 23:38:19'),
(13, 'MARIA', 'maria@gmail.com', '$2y$10$dKUmNfHKvDQHdsx5jvghkedIfO8iZ3eJrkgZg8bHTx956c6Xn0hSu', 'user_default.png', 'TITULADO', 0, '2019-05-03 14:20:59', '2019-05-03 14:20:59'),
...
(1, 19, 1, '2019-04-29 15:10:36', '2019-05-01 20:57:48'),
(2, 29, 2, '2019-05-01 20:37:58', '2019-05-02 22:55:15'),
(3, 3, 3, '2019-05-01 22:18:37', '2019-05-01 22:27:08'),
(4, 0, 4, '2019-05-02 23:05:49', '2019-05-02 23:05:49'),
...
--
ALTER TABLE `titulos`
  ADD CONSTRAINT `titulos_carrera_id_foreign` FOREIGN KEY (`carrera_id`) REFERENCES `carreras` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `titulos_titulado_id_foreign` FOREIGN KEY (`titulado_id`) REFERENCES `titulados` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `visitas`
--
ALTER TABLE `visitas`
  ADD CONSTRAINT `visitas_titulado_id_foreign` FOREIGN KEY (`titulado_id`) REFERENCES `titulados` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
